...
func VenLogin(c *gin.Context) {
	...
	var existinguser model.VendorModel
...
func VenSignup(c *gin.Context) {
	var user model.VendorModel
...
func VenOtpVerify(c *gin.Context) {

	// Bind OTP verification request data
	var OTPverify model.VerifyOTPVendor
	...
	var userData model.VendorModel
